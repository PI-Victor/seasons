    ...
    fn resolved_tokens(&self) -> ThemeTokens {
        ...
        match (self.palette, wants_dark) {
            ...
            (ThemePalette::Seasons, true) => ThemeTokens {
                color_scheme: "dark",
                bg: "#121628",
                bg_elevated: "rgba(18, 22, 40, 0.94)",
                bg_card: "rgba(29, 34, 58, 0.88)",
                line: "rgba(136, 153, 255, 0.2)",
                ...
                page_glow_primary: "rgba(232, 137, 206, 0.22)",
                page_glow_secondary: "rgba(121, 190, 255, 0.18)",
                page_gradient: "linear-gradient(160deg, #121628 0%, #1a1c36 52%, #1c2942 100%)",
                panel_bg: "linear-gradient(160deg, rgba(123, 233, 212, 0.09), rgba(232, 137, 206, 0.07) 44%, transparent 80%), rgba(18, 22, 40, 0.86)",
                banner_bg: "rgba(29, 34, 58, 0.9)",
                pill_bg: "rgba(42, 47, 77, 0.72)",
                pill_border: "rgba(121, 190, 255, 0.2)",
                ghost_bg: "rgba(42, 47, 77, 0.7)",
                ghost_border: "rgba(121, 190, 255, 0.18)",
                secondary_bg: "rgba(55, 60, 92, 0.72)",
                ...
                scene_shell_bg: "rgba(55, 60, 92, 0.5)",
                room_shell_bg: "rgba(29, 34, 58, 0.74)",
                room_shell_border: "rgba(132, 149, 242, 0.18)",
                chip_bg: "rgba(55, 60, 92, 0.72)",
            ...
            (ThemePalette::Seasons, false) => ThemeTokens {
                color_scheme: "light",
                bg: "#f6f7ff",
                bg_elevated: "rgba(246, 247, 255, 0.96)",
                bg_card: "rgba(233, 236, 252, 0.9)",
                line: "rgba(122, 118, 168, 0.14)",
                line_strong: "rgba(255, 143, 94, 0.3)",
                text: "#2e2951",
                ...
                page_glow_primary: "rgba(255, 143, 94, 0.14)",
                page_glow_secondary: "rgba(77, 159, 214, 0.12)",
                page_gradient: "linear-gradient(160deg, #f6f7ff 0%, #ece5fa 52%, #e4f0fa 100%)",
                panel_bg: "linear-gradient(160deg, rgba(123, 233, 212, 0.2), rgba(232, 137, 206, 0.12) 44%, transparent 82%), rgba(246, 247, 255, 0.9)",
                banner_bg: "rgba(233, 236, 252, 0.94)",
                pill_bg: "rgba(255, 255, 255, 0.62)",
                pill_border: "rgba(122, 118, 168, 0.1)",
                ghost_bg: "rgba(255, 255, 255, 0.62)",
                ghost_border: "rgba(122, 118, 168, 0.12)",
                secondary_bg: "rgba(255, 255, 255, 0.76)",
                secondary_border: "rgba(255, 143, 94, 0.16)",
